...
public class StudentManagementSystem extends JFrame {
        ...
        if (enrollmentNoStr != null && !enrollmentNoStr.isEmpty()) {
            ...
            try (PreparedStatement ps = con.prepareStatement(query)) {
                ...
                if (result > 0) {
                    ...
                    JOptionPane.showMessageDialog(this, "No student found with the given Enrollment No.", "Error",
                            JOptionPane.ERROR_MESSAGE);
                }
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(this, "Error deleting student: " + e.getMessage(), "Error",
                        JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    private void updateTable() {
        ...
        for (Student student : students) {
            tableModel.addRow(new Object[] { student.getEnrollmentNo(), student.getName(), student.getSem(),
                    student.getDob(), student.getGrade() });
        }
    }
    ...
    private void editStudent() {
        ...
        try (PreparedStatement ps = con.prepareStatement(query)) {
            ...
            JOptionPane.showMessageDialog(this, "Error updating student: " + e.getMessage(), "Error",
                    JOptionPane.ERROR_MESSAGE);
        }
    }
